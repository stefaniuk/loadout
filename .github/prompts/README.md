...
| [speckit.constitution.prompt.md](speckit.constitution.prompt.md) | Create or update the project constitution from interactive or provided principle inputs, ensuring all dependent templates stay in sync |
