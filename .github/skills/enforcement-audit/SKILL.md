...
| --------------------- | --------------------------------------- | -------------------------------------------------------------- | ----------- | ------------------------------------------------- | ------------------------------------------------------------------- |
| python                | `python.instructions.md`                | `*.py`, `pyproject.toml`, `uv.lock`, `requirements*.txt`       | PY          | `docs/prompts/python-inventory.md`                | `docs/prompts/python-instructions-alignment-plan.md`                |
| typescript            | `typescript.instructions.md`            | `*.ts`, `*.tsx`, `*.js`, `package.json`, `tsconfig.json`       | TS          | `docs/prompts/typescript-inventory.md`            | `docs/prompts/typescript-instructions-alignment-plan.md`            |
| go                    | `go.instructions.md`                    | `*.go`, `go.mod`, `go.sum`                                     | GO          | `docs/prompts/go-inventory.md`                    | `docs/prompts/go-instructions-alignment-plan.md`                    |
| docker                | `docker.instructions.md`                | `Dockerfile`, `Dockerfile.*`, `compose.yaml`, `compose.*.yaml` | DF          | `docs/prompts/docker-inventory.md`                | `docs/prompts/docker-instructions-alignment-plan.md`                |
| rust                  | `rust.instructions.md`                  | `*.rs`, `Cargo.toml`, `Cargo.lock`                             | RS          | `docs/prompts/rust-inventory.md`                  | `docs/prompts/rust-instructions-alignment-plan.md`                  |
| shell                 | `shell.instructions.md`                 | `*.sh`, `*.bash`, `*.zsh`                                      | SH          | `docs/prompts/shell-inventory.md`                 | `docs/prompts/shell-instructions-alignment-plan.md`                 |
| makefile              | `makefile.instructions.md`              | `Makefile`, `*.mk`                                             | MK          | `docs/prompts/makefile-inventory.md`              | `docs/prompts/makefile-instructions-alignment-plan.md`              |
| terraform             | `terraform.instructions.md`             | `*.tf`, `*.tfvars`                                             | TF          | `docs/prompts/terraform-inventory.md`             | `docs/prompts/terraform-instructions-alignment-plan.md`             |
| reactjs               | `reactjs.instructions.md`               | `*.jsx`, `*.tsx`, `*.js`, `*.ts`                               | RJS         | `docs/prompts/reactjs-inventory.md`               | `docs/prompts/reactjs-instructions-alignment-plan.md`               |
| tauri                 | `tauri.instructions.md`                 | `*.rs`, `*.ts`, `*.tsx`, `*.js`, `*.jsx`                       | TAU         | `docs/prompts/tauri-inventory.md`                 | `docs/prompts/tauri-instructions-alignment-plan.md`                 |
| playwright-python     | `playwright-python.instructions.md`     | `*.py`                                                         | PPW         | `docs/prompts/playwright-python-inventory.md`     | `docs/prompts/playwright-python-instructions-alignment-plan.md`     |
| playwright-typescript | `playwright-typescript.instructions.md` | `*.ts`, `*.tsx`                                                | PTW         | `docs/prompts/playwright-typescript-inventory.md` | `docs/prompts/playwright-typescript-instructions-alignment-plan.md` |
