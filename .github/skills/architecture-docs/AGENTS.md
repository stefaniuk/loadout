...
> **Scope.** This file applies only to the `architecture-docs` skill subtree. The canonical baseline is the [root AGENTS.md](../../../AGENTS.md); nothing here may contradict it.
