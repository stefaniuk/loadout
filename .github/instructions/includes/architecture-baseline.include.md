...
- [CBO-SCP-001] Produce and maintain temporary analysis documents under `.copilot/analysis/`.
...
- [CBO-DSC-004] Record any new findings in `.copilot/analysis/repository-map.md` (even if partial).
...
- [CBO-NAV-001] Treat `.copilot/analysis/README.md` as the local analysis landing page.
