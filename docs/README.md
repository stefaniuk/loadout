...
- [catalogue.md](catalogue.md) is the generated inventory of prompts, instructions, agents, skills, hooks, and derived pack metadata.
...
- Readers browsing the shipped asset surface should use [catalogue.md](catalogue.md) and the root [README](../README.md).

## Generated inventories and reports

- [catalogue.md](catalogue.md) is generated by `make catalogue`. Do not hand-edit it.
